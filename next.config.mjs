...
const tracingRoot = process.env.NEXT_TRACING_ROOT_MODE === "workspace"
  ? join(projectRoot, "..")
  : projectRoot;
const proxyClientMaxBodySize = process.env.NEXUS_PROXY_CLIENT_MAX_BODY_SIZE || "128mb";
...
const nextConfig = {
  ...
  webpack: (config, { isServer }) => {
    ...
    config.watchOptions = {
      ...
      ignored: /[\\/](node_modules|\.git|logs|\.next|\.next-cli-build|gitbook|cli|engine\.old|tests|docs)[\\/]/,
    };
    return config;
  },
  async rewrites() {
