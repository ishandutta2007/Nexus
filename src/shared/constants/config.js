...
export const GITHUB_CONFIG = {
  changelogUrl: "https://raw.githubusercontent.com/decolua/nexus/refs/heads/master/CHANGELOG.md",
  donateUrl: "https://nexus.com/api/donate",
};

// Updater configuration
export const UPDATER_CONFIG = {
  npmPackageName: "nexus",
  installCmd: "npm i -g nexus",
  installCmdLatest: "npm i -g nexus@latest --prefer-online",
