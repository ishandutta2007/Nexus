...
// Build TOML config for Nexus (openai provider mode)
const buildNexusConfig = (baseUrl, apiKey, model) => {
...
// Detect Nexus by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildNexusConfig(baseUrl, apiKey || "sk_nexus", model);
