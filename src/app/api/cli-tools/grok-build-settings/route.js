...
import os from "os";
import { getCapabilitiesForModel } from "engine/providers/capabilities.js";
import {
...
const hasNexusConfig = (settings) => Boolean(settings?.model?.base_url);
...
export async function DELETE() {
  try {
    ...
    return NextResponse.json({
      success: true,
      message: "nexus model slots removed from Grok Build",
    });
  } catch (error) {
