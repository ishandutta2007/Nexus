...
import { resolveKiroModels } from "engine/services/kiroModels.js";
import { resolveKimchiModels } from "engine/services/kimchiModels.js";
import { resolveQoderModels } from "engine/services/qoderModels.js";
import { resolveCopilotModels } from "engine/services/copilotModels.js";
import { resolveClinepassModels } from "engine/services/clinepassModels.js";
import { resolveGrokCliModels } from "engine/services/grokCliModels.js";
import { resolveCursorModels } from "engine/services/cursorModels.js";
import { resolveZedModels } from "engine/shared/zedAuth.js";
import { updateProviderCredentials } from "@/sse/services/tokenRefresh";
import { resolveConnectionProxyConfig } from "@/lib/network/connectionProxy";
import { capabilitiesFromServiceKind, getCapabilitiesForModel } from "engine/providers/capabilities.js";
...
// and break recursive loops between nexus instances connected to each other.
const INTERNAL_MODELS_FETCH_HEADER = "x-nx-internal-models-fetch";
...
export async function buildModelsList(kindFilter, options = {}) {
  ...
  // nexus instance's fetchCompatibleModelIds — skip dynamic fetch to break
...
export async function GET(request) {
  try {
    // Detect cross-instance recursive /models fetch (another nexus fetching our /models)
