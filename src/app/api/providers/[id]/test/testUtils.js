...
import { resolveOllamaLocalHost, PROVIDERS } from "engine/config/providers.js";
import {
  refreshProviderCredentials,
  shouldRefreshCredentials,
} from "engine/services/oauthCredentialManager.js";
import {
  GEMINI_CONFIG,
  ANTIGRAVITY_CONFIG,
  KIRO_CONFIG,
...
const OAUTH_TEST_CONFIG = {
  ...
  github: {
    ...
    authHeader: "Authorization",
    authPrefix: "Bearer ",
    extraHeaders: { "User-Agent": "Nexus", "Accept": "application/vnd.github+json" },
  },
  iflow: {
...
async function fetchWithConnectionProxy(url, options = {}, effectiveProxy = null) {
  ...
  if (effectiveProxy?.vercelRelayUrl) {
    const { proxyAwareFetch } = await import("engine/utils/proxyFetch.js");
