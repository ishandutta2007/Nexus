/**
 * `nexus xai video` — generate a Grok Imagine video through the local
 * nexus gateway and save the result as an MP4 file.
 *
...
const HELP = `
Usage: nexus xai video --prompt "..." [options]

Generate a Grok Imagine video via your local nexus gateway
...
Options:
  ...
  --api-key <key>         nexus API key (or env NINE_ROUTER_API_KEY)
...
async function run(argv) {
  ...
  try {
    ...
    const connectionId = create.headers["x-nexus-connection-id"] || null;
