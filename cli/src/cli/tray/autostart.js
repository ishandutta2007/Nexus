...
const APP_LABEL = "com.nexus.autostart";
 ...
 *   2. `process.argv[1]` if it's our cli.js — true when nexus is currently
 ...
 * SIGTERM to the running process. When the running nexus cli.js was itself
...
function enableWindows(cliPath) {
  ...
  // `nexus.cmd` lookup that depended on the npm prefix path.
